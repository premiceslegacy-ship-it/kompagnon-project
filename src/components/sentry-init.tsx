...
export function SentryInit() {
  useEffect(() => {
    const dsn = document.documentElement.dataset.sentryDsn || process.env.NEXT_PUBLIC_SENTRY_DSN
    if (!dsn) return
    ...
    Sentry.init({
      ...
      environment: isLocalRuntime ? 'local-development' : window.location.host,
