...
export type Organization = {
  ...
  secondary_activity_ids: BusinessActivityId[] | null
  ...
  // Module prix matières métaux (migration 120)
  has_metal_pricing?: boolean | null
  // Sous-totaux par lot (migration 126)
  default_show_section_subtotals?: boolean | null
  // Pack verticale métier (migration 164)
  business_vertical_pack?: string | null
  // Autonomie limitée de Sarah sur les actions low risk (migration 177)
  sarah_auto_low_risk?: boolean | null
}
