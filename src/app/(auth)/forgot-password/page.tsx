        ...
        <div className="bg-white/[0.04] backdrop-blur-[40px] border border-white/[0.08] rounded-3xl p-8 lg:p-10">
          ...
          {state.success ? (
            ...
            <div className="flex flex-col items-center text-center gap-4 py-4">
              ...
              <Link
                href="/login"
                className="mt-2 flex items-center gap-2 text-sm text-accent font-semibold hover:opacity-75 transition-opacity"
              >
            ...
            <>
              <div className="mb-7">
                <h2 className="text-2xl font-bold font-display">Mot de passe oublié</h2>
              ...
              <p className="mt-7 text-center text-xs text-white/30">
                <Link href="/login" className="text-accent font-semibold hover:opacity-75 transition-opacity">
