...
| Type | Variables |
|------|-----------|
| **Secret** | `OPERATOR_INGEST_SECRET`, `SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY`, `RESEND_API_KEY`, `OPENROUTER_API_KEY`, `MISTRAL_API_KEY`, `CRON_SECRET`, `SHARED_WABA_ACCESS_TOKEN` |
| **Text** | `OPERATOR_MODE`, `OPERATOR_ALLOWED_EMAILS`, `OPERATOR_SUPABASE_URL`, `OPERATOR_USD_TO_EUR_RATE`, `SUPABASE_URL`, `NEXT_PUBLIC_APP_URL`, `OPERATOR_INGEST_URL`, `OPERATOR_SOURCE_INSTANCE`, `SHARED_WABA_PHONE_NUMBER_ID` et toutes les `NEXT_PUBLIC_LEGAL_*` |
